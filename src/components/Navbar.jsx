...
const Navbar = () => {
  return (
    <nav className="w-full sticky top-0 left-0 right-0 z-50">
      <div className="flex items-center justify-between h-[60px] bg-white shadow-sm px-8">
        ...
        <div className="flex items-center gap-4">
          <button className="relative w-10 h-10 rounded-full bg-teal-500 text-white flex items-center justify-center">
